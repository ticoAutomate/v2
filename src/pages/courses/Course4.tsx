...
const courseContent = {
  en: {
    title: "Career Development and Market Positioning",
    description: "Position yourself in the job market and accelerate your professional growth.",
