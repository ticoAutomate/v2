...
const moduleContent = {
  ...
  description: "Domina los conceptos esenciales de programación necesarios para el desarrollo de RPA. Aprende sobre variables, tipos de datos, estructuras de control y mejores prácticas para el desarrollo de automatizaciones.",
  sections: [
    {
      title: "Parte 1: Elementos básicos de programación",
      video: "M2C1_1de4.mp4",
      content: [
        {
          title: "Fundamentos de Programación",
          items: [
            ...
            "Controles de flujo básicos"
          ]
        }
      ]
    },
    {
      title: "Parte 2: Manejo de Excepciones",
      video: "M2C1_2de4.mp4",
      content: [
        {
    ...
    {
      title: "Parte 3: Estructuras de Control",
      video: "M2C1_3de4.mp4",
      content: [
        {
  ...
  resources: [
    {
      ...
      type: "link",
      url: "https://panamahitek.com/operadores-logicos-en-arduino/"
    },
    {
      title: "Resumen de Tipos de Datos",
      type: "link",
      url: "https://learn.microsoft.com/en-us/office/vba/language/reference/user-interface-help/data-type-summary"
    },
    {
      title: "Operadores de Comparación",
      type: "link",
      url: "https://learn.microsoft.com/en-us/dotnet/visual-basic/language-reference/operators/comparison-operators"
    },
    {
      title: "IF/then/Else",
      type: "link",
      url: "https://learn.microsoft.com/es-es/dotnet/visual-basic/language-reference/statements/if-then-else-statement"
    },
    {
    ...
    {
      title: "Instrucción For Each",
      type: "link",
      url: "https://learn.microsoft.com/es-es/dotnet/visual-basic/language-reference/statements/for-each-next-statement"
    }
  ]
};
